...
The node client library is tested against the latest Node 8 LTS.

To use in older node versions (4, 5 or 6), please use [simple-oauth2@1.x](https://github.com/lelylan/simple-oauth2/tree/1.5.0).
