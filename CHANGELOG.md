...
* Allow to override the grant type on each flow (#254)
* Don't mutate params on getToken method (#254)
* Properly encode multiple scopes when specified as an array (#254)
