...
module.exports = function (config) {
    ...
    //High level method to call API and send data Json format
    function apiJson(method, path, params, callback) {
    ...
    function call(method, url, params, callback) {
        ...
        //Check if is Json Call
        if (params.hasOwnProperty('is_json') && params.is_json) {
        ...
        // If is Json then force params to be Json Mode
        if (params.hasOwnProperty('is_json') && params.is_json) {
            delete params.is_json;
            options.json = params;
