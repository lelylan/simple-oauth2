...
module.exports = function (config) {
  ...
  function call(method, url, params, callback) {
    ...
    if ('ca' in config) options.ca = config.ca;
    if ('agent' in config) options.agent = config.agent;
    if ('rejectUnauthorized' in config) options.rejectUnauthorized = config.rejectUnauthorized;
