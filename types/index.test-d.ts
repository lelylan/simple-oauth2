...
(async () => {
    ...
    try {
        ...
        console.log("Access Token Error", (error as Error).message);
    }
})();
  ...
  oauthSubject:
    ...
    if (accessToken.expired()) {
        try {
            ...
            console.log("Error refreshing access token: ", (error as Error).message);
        }
    }
    ...
    try {
        ...
        console.log("Error revoking token: ", (error as Error).message);
    }
